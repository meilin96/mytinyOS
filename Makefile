...
build/kernel.bin:build/timer.o build/main.o build/init.o build/interrupt.o build/print.o build/kernel.o build/debug.o build/string.o build/bitmap.o build/memory.o
	ld -m elf_i386 -Ttext 0xc0001500 -e main -o build/kernel.bin build/main.o build/init.o build/interrupt.o build/print.o build/kernel.o build/timer.o build/debug.o build/string.o build/bitmap.o build/memory.o
